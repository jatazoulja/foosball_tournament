...
SELECT T1.id as id1, T2.id as id2, T1.name as team1, T2.name as team2
FROM (SELECT DISTINCT id, name FROM teams) T1,
     (SELECT DISTINCT id, name FROM teams) T2
WHERE T2.id > T1.id ORDER BY T1.id ASC LIMIT 999